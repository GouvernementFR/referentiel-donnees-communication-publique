...
| `document.id`                                           | UUID v4              | Oui         | Identifiant unique universel du communiqué                                                                                | `"b8c9d0e1-f2a3-4b4c-5d6e-7f8a9b0c1d2e"` |
...
| `document.url`                                          | URL (HTTPS)          | non         | URL absolue faisant office de canonical du document presse. Protocole HTTPS.                                              | `"https://www.interieur.gouv.fr/actualites/actualites-du-ministere/sur-terre-et-dans-airs-combattre-feu-sur-tous-fronts"` |
...
| `document.lieu_publication`                             | chaîne               | Oui         | Lieu d'émission. Par convention, `"Paris"` lorsqu'il y a plusieurs émetteurs                                              | `"Hôtel de Matignon"` |
| `document.date_publication`                             | date (ISO 8601)      | Oui         | Date de publication                                                                                                       | `"2026-03-27"` |
...
| `document.contenu_pdf.lien_telechargement`              | URL                  | Oui (2)     | URL de téléchargement (HTTPS). Chaque version PDF sera récupérée par info.gouv.fr et mise à disposition sous son domaine. |  |
| `document.contenu_pdf.poids`                            | entier (octets)      | Oui (2)     | Poids du fichier                                                                                                          | `2048000` |
...
(2) Obligatoire uniquement si `document.contenu_pdf` est présent (l'objet lui-même est optionnel)
